...
class Face_Recognition:
    def __init__(self, root):
        ...
        # button
        b1_1 = Button(f_lbl, text="Press To Recognize the face", command=self.face_recog,
                      cursor="hand2", font=("times new roman", 12, "bold"), bg="darkgreen", fg="white")
        b1_1.place(x=365, y=620, width=200, height=40)

        back_1 = Button(f_lbl, text="Back", command=self.iExit, cursor="hand2", font=(
            "times new roman", 12, "bold"), bg="red", fg="white")
        back_1.place(x=650, y=620, width=200, height=40)

        attendance = Button(f_lbl, text="Get Attendance Data", command=self.attendance_data,
                            cursor="hand2", font=("times new roman", 12, "bold"), bg="Orange", fg="white")
        attendance.place(x=650, y=560, width=200, height=40)

        # back_btn=Button(f_lbl,text="Back",command=self.iExit,width=18,)
